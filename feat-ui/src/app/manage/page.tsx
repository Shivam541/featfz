...
import { ManageModule } from "@/components/manage-module";
        ...
        <header className="glass-panel rounded-[var(--radius-xl)] px-5 py-4">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            <div>
              ...
              <h1 className="text-2xl font-semibold tracking-[-0.04em]">Manage flags</h1>
              <p className="mt-1 max-w-2xl text-sm text-[var(--muted)]">
                Create, update, and archive flags without mixing those flows into the read/evaluate experience.
              </p>
            </div>
